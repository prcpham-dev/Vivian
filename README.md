...
1. **Accessing Settings:**  
   ...
   <img src="assets/setting.png" width="400" alt="Vivian Settings">

2. **Providing the Gemini API Key:**  
...
2. Search for and run the command: **`Vivian: Open MCP Setup Instructions`** or click on:
   
   <img src="assets/mcpSetup.png" width="400" alt="MCP Setup">
   
3. Follow the next few steps detailed in the panel.
